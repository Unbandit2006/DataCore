...
class Sales:
    ...
    def draw(self, surf: pygame.surface.SurfaceType):
        ...
        info_surf = pygame.Surface((surf.get_width()-show_all_widget.width-show_all_widget.x-10, surf.get_height()-10))
        info_surf.fill("#7d8cbb")

        if self.info is not None:
            if self.info.lower() == "weekly":
                bargraph = dave.BarGraph(info_surf, axis_labels=["Weekly", "Total Sales"])
        ...
        surf.blit(info_surf, (10+show_all_widget.width, 5))
